...
# Create imported target lldConfig
add_library(lldConfig STATIC IMPORTED)
...
set_target_properties(lldDriver PROPERTIES
  INTERFACE_LINK_LIBRARIES "lldConfig;lldMachO;lldCOFF;lldELF;lldELF2;lldAArch64ELFTarget;lldARMELFTarget;lldHexagonELFTarget;lldMipsELFTarget;lldX86ELFTarget;lldExampleSubTarget;lldX86_64ELFTarget;lldCore;lldReaderWriter;lldYAML;LLVMObject;LLVMOption;LLVMSupport"
)
...
set_target_properties(lldELF PROPERTIES
  INTERFACE_LINK_LIBRARIES "lldReaderWriter;lldCore;lldYAML;LLVMObject;LLVMSupport"
)

# Create imported target lldX86ELFTarget
add_library(lldX86ELFTarget STATIC IMPORTED)

set_target_properties(lldX86ELFTarget PROPERTIES
  INTERFACE_LINK_LIBRARIES "lldELF;lldReaderWriter;lldCore;LLVMObject;LLVMSupport"
)

# Create imported target lldX86_64ELFTarget
add_library(lldX86_64ELFTarget STATIC IMPORTED)

set_target_properties(lldX86_64ELFTarget PROPERTIES
  INTERFACE_LINK_LIBRARIES "lldELF;lldReaderWriter;lldCore;LLVMObject;LLVMSupport"
)

# Create imported target lldExampleSubTarget
add_library(lldExampleSubTarget STATIC IMPORTED)

set_target_properties(lldExampleSubTarget PROPERTIES
  INTERFACE_LINK_LIBRARIES "lldX86_64ELFTarget;lldELF;lldReaderWriter;lldCore;LLVMObject;LLVMSupport"
)

# Create imported target lldMipsELFTarget
add_library(lldMipsELFTarget STATIC IMPORTED)

set_target_properties(lldMipsELFTarget PROPERTIES
  INTERFACE_LINK_LIBRARIES "lldELF;lldReaderWriter;lldCore;LLVMObject;LLVMSupport"
)

# Create imported target lldHexagonELFTarget
add_library(lldHexagonELFTarget STATIC IMPORTED)

set_target_properties(lldHexagonELFTarget PROPERTIES
  INTERFACE_LINK_LIBRARIES "lldELF;lldReaderWriter;lldCore;LLVMObject;LLVMSupport"
)

# Create imported target lldAArch64ELFTarget
add_library(lldAArch64ELFTarget STATIC IMPORTED)

set_target_properties(lldAArch64ELFTarget PROPERTIES
  INTERFACE_LINK_LIBRARIES "lldELF;lldReaderWriter;lldCore;LLVMObject;LLVMSupport"
)

# Create imported target lldARMELFTarget
add_library(lldARMELFTarget STATIC IMPORTED)
...
set_target_properties(lldMachO PROPERTIES
  INTERFACE_LINK_LIBRARIES "lldCore;lldYAML;LLVMObject;LLVMSupport"
)
...
set_target_properties(lldCOFF PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMX86CodeGen;LLVMX86AsmPrinter;LLVMX86AsmParser;LLVMX86Desc;LLVMX86Info;LLVMX86Disassembler;LLVMARMCodeGen;LLVMARMAsmPrinter;LLVMARMAsmParser;LLVMARMDesc;LLVMARMInfo;LLVMARMDisassembler;LLVMAArch64CodeGen;LLVMAArch64AsmPrinter;LLVMAArch64AsmParser;LLVMAArch64Desc;LLVMAArch64Info;LLVMAArch64Disassembler;LLVMCore;LLVMLTO;LLVMLibDriver;LLVMObject;LLVMMC;LLVMMCDisassembler;LLVMTarget;LLVMOption;LLVMSupport"
)

# Create imported target lldELF2
add_library(lldELF2 STATIC IMPORTED)

set_target_properties(lldELF2 PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMObject;LLVMOption;LLVMMC;LLVMSupport"
)
